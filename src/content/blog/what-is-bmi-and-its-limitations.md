...
Calculate your BMI with the [BMI Calculator](/health/bmi-calculator/) and then use it as a starting point, not a diagnosis. A BMI outside the normal range warrants a closer look at body composition, waist circumference, and metabolic markers, but it is not a definitive statement about your health.
