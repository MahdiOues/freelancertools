...
Rather than crunching these numbers by hand, use the [Investment Return Calculator](/finance/investment-return/) to see how different investments perform over time. Enter your initial investment, monthly contributions, expected return rate, and time horizon. The calculator shows both the final value and the CAGR, helping you compare different scenarios.
