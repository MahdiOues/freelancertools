---
title: "Overdue Invoice Email Templates That Actually Get You Paid"
description: "Four email templates for overdue invoices: friendly reminder, due date reminder, first overdue notice, and final notice with late fee. Includes psychology of each stage."
date: 2026-06-09
category: Freelancer
...
Use the [Free Late Fee Calculator](/freelancer/late-fee-calculator/) to calculate the exact fee before you add it to a final notice. Send a revised invoice that shows the original amount and the late fee as a separate line item so the client sees exactly what the delay cost them.

Pair these templates with a solid invoice that has clear terms from the start. Use the [Invoice Generator](/freelancer/invoice-generator/) to create invoices with built-in payment terms, due dates, and late fee language so your clients know the rules before the work starts.

## Frequently asked questions

<details><summary>How do you politely ask for overdue payment?</summary>
Be polite in the first two emails, direct in the third, and firm in the fourth. The friendly reminder says "heads up." The due date reminder says "due today." The first overdue notice says "is overdue." The final notice says "late fee applied and work paused." Politeness is about tone, not weakness. You can be direct without being rude.
</details>

<details><summary>What is a reasonable late fee for freelancers?</summary>
1.5% per month (18% APR) is the standard across the freelance industry. It is high enough to encourage timely payment and low enough to be enforceable in court. Some freelancers charge a flat $25 or $50 late fee instead of a percentage. Flat fees are simpler but less proportional — a $50 fee on a $10,000 invoice is too small to matter.
</details>

<details><summary>How many reminders should I send before stopping work?</summary>
Three reminders, then stop work. Send the friendly reminder a day before the due date, the due date reminder on the day of, the first overdue notice at day 7, and the final notice at day 30. If the client has not paid by the final notice deadline, pause all active work. Do not start new projects for a client with an overdue balance. Every hour you work for them increases your exposure.
</details>

<details><summary>Can I charge interest on a late invoice?</summary>
Yes, if your contract or invoice terms specify a late fee or interest rate. Without written terms, you cannot unilaterally add interest to a past-due invoice in most jurisdictions. Add the clause to your contract before the work starts and include it in the payment terms on every invoice. Even a simple sentence at the bottom of the invoice — "Late payments subject to 1.5% monthly interest" — is enough to establish the terms.
</details>

<details><summary>What should I do if a client refuses to pay?</summary>
Send the final notice with the late fee applied and pause all work. If that does not get results, send a demand letter via certified mail giving them 10 days to pay. After that, your options are small claims court (for amounts under $5,000 to $10,000 depending on your state), a collections agency (which takes 25-50% of the recovered amount), or writing it off as a bad debt if the legal costs exceed the invoice value. Some clients will not pay no matter what you do. Your contract and your willingness to walk away are the only leverage you have.
</details>
