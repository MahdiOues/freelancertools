...
Track your budget with the [Budget Planner](/finance/budget-planner/) to see how your current allocation compares to the targets. Adjust as your income and expenses change.
...
The 50/30/20 budget rule splits your after-tax income into three categories: 50% for needs (housing, food, utilities), 30% for wants (entertainment, dining out, hobbies), and 20% for savings and debt repayment. It was popularized by Senator Elizabeth Warren and is a simple framework for managing your money without tracking every penny.
</details>

<details>
<summary>What counts as needs vs wants?</summary>

Needs are expenses you cannot avoid: rent or mortgage, groceries, utilities, minimum loan payments, insurance, and basic transportation. Wants are everything optional: streaming services, restaurant meals, new clothes, travel, and hobbies. If you earn $4,000/month after taxes, $2,000 goes to needs and $1,200 to wants.
</details>

<details>
<summary>How do I apply 50/30/20 with irregular income?</summary>

If your income varies month to month, calculate your baseline using your lowest-earning month from the past year. Direct all income into a holding account and pay yourself a fixed monthly salary based on that baseline. During high-earning months, save the excess to cover shortfalls during lean months.
</details>

<details>
<summary>What if my needs cost more than 50%?</summary>

If your needs exceed 50%, you must reduce needs (downsize housing, refinance debt) or reduce wants. If you cannot cut needs enough, adjust the split to something like 60/20/20 or 60/15/25. The rule is a guideline — in high-cost cities like New York or San Francisco, many people allocate 60-65% to needs.
</details>

<details>
<summary>Where does debt repayment fit in the 50/30/20 budget?</summary>

Minimum debt payments count as needs under the 50% category. Any extra payments beyond the minimum come out of the 20% savings category. For example, if your minimum credit card payment is $100, that goes in needs; paying an extra $200 to clear the balance faster comes from the savings portion.
</details>
