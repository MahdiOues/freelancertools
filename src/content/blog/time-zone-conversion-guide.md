...
Set your calendar to display in UTC to avoid confusion when scheduling across time zones. Use the [Time Zone Converter](/math/time-zone-converter/) to double-check meeting times before sending invites. A good rule of thumb is to find the overlapping business hours between zones and stick to those windows.
