---
title: "How to Figure Out What to Charge as a Freelancer"
description: "Stop guessing your freelance rate. Use this formula to calculate your minimum hourly rate, compare project vs hourly pricing, and raise rates without losing clients."
date: 2026-06-09
category: Freelancer
...
$85/hour × 40 hours = $3,400 base fee
$3,400 × 20% buffer = $680
Total quote: $4,080
...
<details><summary>What is a good hourly rate for a beginner freelancer?</summary>
A beginner with less than a year of experience should calculate their minimum using the formula above, then expect to fall near the bottom of their niche range. For most fields, that means $35-55 per hour. Do not go below $30/hour under any circumstance. Below that threshold, you cannot cover taxes and expenses, and the math will not work no matter how many hours you bill.
</details>

<details><summary>How do I calculate my freelance rate from my salary?</summary>
Take your current salary and multiply by 1.3 to account for self-employment taxes and lost benefits. A $65,000 salary becomes $84,500. Add your annual business expenses — roughly $5,400 for software, equipment, and a home office. Divide by your realistic billable hours, which for a new freelancer is about 1,200 per year. ($84,500 + $5,400) / 1,200 = $74.92 per hour. Use the [Salary to Hourly Calculator](/freelancer/salary-to-hourly/) to run your own numbers.
</details>

<details><summary>Should I charge hourly or per project?</summary>
Charge per project whenever you can define the deliverables upfront. Hourly rates make sense only for maintenance work, consulting calls, and clients who change scope constantly. The fastest way to raise your effective hourly income without changing your rate is to switch from hourly to project pricing — because you stop being penalized for working fast.
</details>

<details><summary>How do I know if my rate is too low?</summary>
Three signs: you are always booked but never have enough money at the end of the month. Your clients never negotiate your price down. You dread starting new projects because the pay does not match the effort. If any of these describe you, calculate your minimum rate and compare it to what you charge. If the gap is larger than $15/hour, you are losing money on every project.
</details>

<details><summary>How often should I raise my freelance rates?</summary>
Raise rates for new clients every time you add a meaningful skill or complete a high-profile project. For existing clients, every 12-18 months with 60 days written notice. If you go longer than two years without a rate increase, inflation alone has cut your real income by 6-10%, and you took a pay cut without realizing it. Use the [Freelancer Rate Calculator](/freelancer/rate-calculator/) to model different rate scenarios and see the annual difference.
</details>
